...
function LeftLogin({ state, setState }) {
    ...
    return (
        <div className='p-0 col-12' style={{ backgroundColor: "transparent" }}>
            <ToastContainer style={{ position: "absolute", top: "0px", left: "0px" }} />
            <Spinner loading={loading} />
            <div className="row col-12 p-0 m-auto">
                <div className="col-6"
                    style={{
                        height: "60px", backgroundColor: "#7E21DB",
                        borderRadius: "5px 5px 0px 0px", marginTop: "-8px",
                        cursor: "pointer"
                    }} onClick={() => setState({ ...state, selected: "left" })} >
                    <h6 className='mt-2 text-light text-center'>Find an Interpreter</h6>
                </div>
                <div className="col-6 text-center" onClick={() => setState({ ...state, selected: "right" })}
                    style={{
                        backgroundColor: "#4F4F4F", borderRadius: "5px 5px 0px 0px",
                        fontSize: "20px", margin: "0 0 0 0", cursor: "pointer"
                    }} >
                    <h3 style={{ color: "white", fontSize: "20px" }}>I'm an Interpreter</h3>
                </div>
            </div>
            <div className='row m-auto col-12 p-2 rounded'
                ...
                <div className="col-6">
             ...
             </h6> : <h6 className='ml-0 mt-1 mb-0' style={{ color: "#AB57FF" }}>
                                    Sign up with us
             </h6> :
                    ...
                    <label style={{
                        fontSize: "12px", transition: "0.5s ease",
                        display: state.lSelected !== 'login' ? "block" : "none"
                    }} className=' m-0 text-light' htmlFor="input">Name</label>
                    <input type="text" className='col-12 p-1 pl-2 border-0'
                        style={{ borderRadius: "3px", fontSize: "16px", transition: "0.5s ease", display: state.lSelected !== 'login' ? "block" : "none" }}
                    ...
                    <p style={validation} className={nameok === false ? "d-block" : 'd-none'}>this field is required and should be greater than 3</p>
                    <label style={{ fontSize: "12px" }} className=' m-0 text-light' htmlFor="input">Email</label>
                    <input type="text" className='col-12 p-1 pl-2 border-0'
                    ...
                    <p style={validation} className={mailok === false ? "d-block" : 'd-none'}>this field is required</p>

                    {
                        state.lfp !== true ?
                            <>
                                <label style={{ fontSize: "12px" }} className=' m-0 text-light' htmlFor="input">Password</label>
                                <div className='col-12 p-0 bg-light' style={{ borderRadius: "3px" }}>
                                    {/* <input 
                  ...
                  autoComplete="new-password"
                    ...
                    icon={state.ipassvisible===false?faEye:faEyeSlash} /> */}
                                ...
                                <p style={validation} className={passok === false ? "d-block" : 'd-none'}>this field is required and should be greater than 3</p>
                                <h5
                                    style={{
                                        color: "#AB57FF", fontSize: "10px",
                                        margin: "0 0 0 0", cursor: 'pointer', display: state.lSelected === 'login' ? "block" : "none"
                                    }}
                                    onClick={() => setState({ ...state, lfp: true, rpf: false })}>Forgot password ?</h5>
                                <p style={{ fontSize: "12px" }} className='m-0 text-light'>or login using</p>
                                <div className='row col-12 m-auto p-0'>
                                    <div className='col-3 pl-0 pt-2'>
                                        <GoogleLogin
                                            ...
                                            render={renderProps => (
                                                <button className='btn btn-light p-0' onClick={renderProps.onClick}
                                                    style={iconStyle}>
                                                    <img src={g_icon} alt="img" className='col-10 m-auto p-0' />
                                                </button>)}
                                        />
                                    </div>
                                    <div className='col-3 pl-0 pt-2'>
                                        ...
                                        >
                                            <button className='btn btn-light p-0' style={iconStyle}>
                                                <img src={f_icon} alt="img" className='col-10 m-auto p-0' />
                                            </button>
                                        </SocialButton>
                                    </div>
                                    <div className='col-3 pl-0 pt-2'>
                                        <MicrosoftLogin
                                            ...
                                            children={<button className='btn btn-light p-0' style={iconStyle}>
                                                <img className='col-7 m-auto p-0'
                                ...
                                </div>
                                {
                                    state.lSelected !== 'login' ?
                                        <button
                                            onClick={state.iregsisterok === true ? register : (() => console.log('please fill required fields'))}
                                        ...
                                        <button className='border-0 mt-2 mb-2 text-light pt-2 pb-2 pl-3 pr-3'
                                            onClick={
                                                state.iloginok === true ? login :
                                                    () => {
                            ...
                            <>
                                <button
                                    className='border-0 mt-2 mb-2 text-light pt-2 pb-2 pl-3 pr-3'
                                    onClick={state.iresetok === true ? resetPass : (() => console.log('please fill required fields'))}
                                    style={{
                                        backgroundColor: "#6B20B6",
                                        fontSize: "16px",
                                        borderRadius: "5px"
                                    }}>Reset Password</button>
                                <h5 style={{ color: "#AB57FF", fontSize: "15px", margin: "0 0 0 0", cursor: "pointer" }}
                                    onClick={() => setState({ ...state, lfp: false, rpf: false })}>
                                    <p className='h3 d-inline-block mr-2' style={{ color: "#AB57FF", fontWeight: "bold" }}>&laquo;</p>
                   Back to Login</h5>
                            </>
                    }
                </div>
                    ...
                    }
                    {
                        state.lSelected !== 'register' ?
                            <h5 className='m-0 p-0' onClick={() => setState({ ...state, lSelected: 'register' })}
                                style={{ color: "#AB57FF", fontSize: "20px", cursor: "pointer" }}>Sign right up!</h5> :
                            <h5 className='m-0 p-0' onClick={() => setState({ ...state, lSelected: 'login' })}
                                style={{ color: "#7E21DB", fontSize: "20px", cursor: "pointer" }}>Go to login</h5>
                    }
